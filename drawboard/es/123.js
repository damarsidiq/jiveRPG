...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 261px; left: 352px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">En la oficina, colgaron nuevos 'tableros' de anuncios con las metas del mes.</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 352px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">In the office, they hung new announcement boards with the month's goals</div>`;
