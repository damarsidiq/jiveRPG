...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 563px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">Si los datos sensibles se filtran, la reputación de la marca colapsa en horas</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 561px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">Las dudas sobre el futuro se filtran lentamente entre los empleados más leales</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 557px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">Doubts about the future slowly filter through among the most loyal employees</div>`;
