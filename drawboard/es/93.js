...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 563px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">Aceptar ese trato sería un paso menos digno para nuestra visión a largo plazo.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 561px; font-size: 12px; font-family: NotoSansSemiCondensedLight;">A veces, la opción menos digno es la única que garantiza la supervivencia inmediata</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 561px; font-size: 11px; font-family: NotoSansSemiCondensedLight;">Sometimes, the less honorable option is the only one that guarantees immediate survival</div>`;
