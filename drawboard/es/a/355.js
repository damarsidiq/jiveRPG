...
vt[vt.length]=`<div id="text_20" class="textshirt mergershirt" style="top: 154px; left: 326px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Ella 'creía' en los finales felices.</div>`;
...
vt[vt.length]=`<div id="text_22" class="textshirt mergershirt" style="top: 374px; left: 906px; font-size: 33px; font-family: NotoSansSemiCondensedLight;">Creía</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+` copytopaste" style="top: 154px; left: 326px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">She 'believed' in happy endings.</div>`;
...
vte[vte.length]=`<div id="text_6" class="textshirt mergershirt`+transws+` copytopaste" style="top: 376px; left: 739px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">I/he/she believed / used to believe / thought.</div>`;
