...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 88px; left: 666px; font-size: 25px; font-family: NotoSansSemiCondensedLight;">No es culpa tuya, no te preocupes.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 233px; left: 667px; font-size: 27px; font-family: NotoSansSemiCondensedLight;">Siente culpa por lo que hizo.</div>`;
...
vte[vte.length]=`<div id="text_14" class="textshirt mergershirt`+transws+`" style="top: 88px; left: 666px; font-size: 25px; font-family: NotoSansSemiCondensedLight;">It's not your fault, don't worry.</div>`;
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 233px; left: 667px; font-size: 27px; font-family: NotoSansSemiCondensedLight;">He feels guilt for what he did.</div>`;
