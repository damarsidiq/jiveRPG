...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 88px; left: 666px; font-size: 23px; font-family: NotoSansSemiCondensedLight;">Su voz resuena en toda la habitación.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 233px; left: 667px; font-size: 21px; font-family: NotoSansSemiCondensedLight;">Este mensaje resuena con mucha gente.</div>`;
...
vte[vte.length]=`<div id="text_14" class="textshirt mergershirt`+transws+`" style="top: 88px; left: 666px; font-size: 23px; font-family: NotoSansSemiCondensedLight;">His voice echoes throughout the room.</div>`;
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 233px; left: 667px; font-size: 21px; font-family: NotoSansSemiCondensedLight;">This message resonates with many people.</div>`;
