...
vt[vt.length]=`<div id="text_20" class="textshirt mergershirt" style="top: 154px; left: 326px; font-size: 17px; font-family: AvenirBook;">El jefe 'asintió' con la cabeza en señal de aprobación.</div>`;
...
vt[vt.length]=`<div id="text_22" class="textshirt mergershirt" style="top: 379px; left: 878px; font-size: 33px; font-family: FuturaBook;">Asintió</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 154px; left: 326px; font-size: 17px; font-family: AvenirBook;">The boss 'nodded' in approval.</div>`;
...
vte[vte.length]=`<div id="text_6" class="textshirt mergershirt`+transws+`" style="top: 385px; left: 671px; font-size: 13px; font-family: FuturaBook;">He/she nodded; he/she assented; he/she agreed silently.</div>`;
