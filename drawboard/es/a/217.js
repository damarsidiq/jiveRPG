...
vt[vt.length]=`<div id="text_8" class="textshirt mergershirt" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 18px; color: rgb(81, 81, 81);">La actriz tiende a 'sobrevalorarse' en las entrevistas.</div>`;
...
vte[vte.length]=`<div id="text_8" class="textshirt mergershirt`+transws+`" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 18px; color: rgb(81, 81, 81);">The actress tends to overrate herself in interviews</div>`;
