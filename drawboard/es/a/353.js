...
vt[vt.length]=`<div id="text_20" class="textshirt mergershirt" style="top: 154px; left: 326px; font-size: 17px; font-family: AvenirBook;">Él 'contaba' con que lo ayudaríamos con la mudanza.</div>`;
...
vt[vt.length]=`<div id="text_22" class="textshirt mergershirt" style="top: 372px; left: 859px; font-size: 33px; font-family: FuturaBook;">Contaba</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+` copytopaste" style="top: 154px; left: 326px; font-size: 17px; font-family: AvenirBook;">He 'was counting on' us helping him with the move.</div>`;
...
vte[vte.length]=`<div id="text_6" class="textshirt mergershirt`+transws+` copytopaste" style="top: 374px; left: 692px; font-size: 13px; font-family: FuturaBook;">He/she/it was telling / was counting / used to count.</div>`;
