...
vt[vt.length]=`<div id="text_20" class="textshirt mergershirt" style="top: 154px; left: 326px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">¿Le vas a 'contarle' la verdad a tus padres?</div>`;
...
vt[vt.length]=`<div id="text_22" class="textshirt mergershirt" style="top: 379px; left: 853px; font-size: 33px; font-family: NotoSansSemiCondensedLight;">Contarle</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 154px; left: 326px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Are you going 'to tell' your parents the truth?</div>`;
...
vte[vte.length]=`<div id="text_6" class="textshirt mergershirt`+transws+`" style="top: 387px; left: 529px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">To tell him/her; to recount to him/her; to count for him/her, depending on context.</div>`;
