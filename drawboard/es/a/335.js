...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt copytopaste" style="top: 157px; left: 353px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">'Confío' en ti, no me decepciones.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt copytopaste" style="top: 261px; left: 352px; font-size: 21px; font-family: NotoSansSemiCondensedLight;">No 'confío' en lo que dice ese político.</div>`;
...
vte[vte.length]=`<div id="text_19" class="textshirt mergershirt`+transws+`" style="top: 157px; left: 353px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">I trust you, don't let me down.</div>`;
vte[vte.length]=`<div id="text_20" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 352px; font-size: 21px; font-family: NotoSansSemiCondensedLight;">I don't trust what that politician says.</div>`;
