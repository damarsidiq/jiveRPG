...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 276px; left: 711px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">Tuvo un papel destacado en la reunión</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 276px; left: 711px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">He had a prominent role in the meeting.</div>`;
