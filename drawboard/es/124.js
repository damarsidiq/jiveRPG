...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 261px; left: 352px; font-size: 15px; font-family: NotoSansSemiCondensedLight;">Nadie puede 'detener' el progreso de la tecnología si no lo frenamos nosotros mismos</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 352px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">No one can stop technological progress if we don't slow it down ourselves</div>`;
