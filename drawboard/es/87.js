...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 276px; left: 711px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">Tenemos que superar muchos obstáculos para terminar el proyecto</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 276px; left: 711px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">We have to overcome many obstacles to finish the project.</div>`;
