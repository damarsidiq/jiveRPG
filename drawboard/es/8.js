...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 185px; left: 204px; font-size: 21px; font-family: NotoSansSemiCondensedLight; color: rgb(10, 114, 50);">Este medicamento 'suprime' los síntomas de la alergia rápidamente</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 318px; left: 205px; font-size: 21px; font-family: NotoSansSemiCondensedLight; color: rgb(12, 55, 84);">El nuevo sistema 'suprime' automáticamente los archivos duplicados</div>`;
...
vte[vte.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 185px; left: 204px; font-size: 21px; font-family: NotoSansSemiCondensedLight; color: rgb(10, 114, 50);">This medication 'suppresses' allergy symptoms quickly.</div>`;
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 318px; left: 237px; font-size: 21px; font-family: NotoSansSemiCondensedLight; color: rgb(12, 55, 84);">The new system automatically 'deletes' duplicate files.</div>`;
