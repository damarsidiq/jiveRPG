...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 563px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">El éxito de la empresa está profundamente ligado a la confianza de sus usuarios</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 561px; font-size: 12px; font-family: NotoSansSemiCondensedLight;">Su destino y el de la comunidad están profundamente ligados por siglos de historia</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 557px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">His destiny and that of the community are intricately tied by centuries of history</div>`;
