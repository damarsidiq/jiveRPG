...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 288px; left: 388px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">Su voz 'aterciopelada' cautivó a todo el público en el concierto</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 288px; left: 395px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">His 'velvety' voice captivated the entire audience at the concert</div>`;
