...
vte[vte.length]=`<div id="text_14" class="textshirt mergershirt`+transws+`" style="top: 157px; left: 353px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">It's better not to pretend interest if you really don't care about the project</div>`;
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 352px; font-size: 23px; font-family: NotoSansSemiCondensedLight;">The actor had to pretend to be sick to exit the scene</div>`;
