...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 288px; left: 400px; font-size: 19px; font-family: NotoSansSemiCondensedLight;">Necesito una pared 'lisa y plana' para instalar el estante</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 288px; left: 395px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">I need a 'smooth and flat' wall to install the shelf</div>`;
