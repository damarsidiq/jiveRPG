...
vte[vte.length] = `<div id="text_29" class="textshirt mergershirt `+transws+`" style="top: 157px; left: 436px; font-size: 15px;">mechanistically, nicotine increases neural activity in certain pathways.</div>`;
vte[vte.length] = `<div id="text_31" class="textshirt mergershirt `+transws+`" style="top: 278px; left: 252px; font-size: 15px;">To get to the village, you have to take  'certain routes'  that do not appear on the GPS.</div>`;
vte[vte.length] = `<div id="text_30" class="textshirt mergershirt `+transws+`" style="top: 414px; left: 251px; font-size: 15px;">  The infection can spread through  'certain pathways'  that we do not yet fully understand.</div>`;
vte[vte.length] = `<div id="text_28" class="textshirt mergershirt `+transws+`" style="top: 581px; left: 632px; font-size: 25px;">certain pathways / certain routes</div>`;
