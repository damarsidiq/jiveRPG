...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 258px; left: 354px; font-size: 16px; font-family: NotoSansSemiCondensedLight;">El tráfico está totalmente 'bloqueado' en la autopista debido a un accidente.</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 258px; left: 354px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">Traffic is totally blocked on the highway due to an accident.</div>`;
