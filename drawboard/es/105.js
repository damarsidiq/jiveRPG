...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 288px; left: 385px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">Coloca la cámara así, 'apuntando' ligeramente hacia abajo para capturar a todos en la cena</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 288px; left: 386px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">Position the camera like this, pointing slightly downwards to capture everyone at the dinner</div>`;
