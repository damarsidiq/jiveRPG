...
vte[vte.length]=`<div id="text_14" class="textshirt mergershirt`+transws+`" style="top: 158px; left: 350px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">If you think you can arrive late without consequences, you are wrong</div>`;
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 348px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Many mistake the marketing strategy with just posting on social media</div>`;
