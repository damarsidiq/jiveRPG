...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 157px; left: 353px; font-size: 15px; font-family: NotoSansSemiCondensedLight;">Antes de liderar un equipo, primero debes 'comprenderte' a ti mismo y tus fortalezas.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 261px; left: 352px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">En esa relación complicada, ellos nunca lograron 'comprenderse' mutuamente.</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 261px; left: 352px; font-size: 16px; font-family: NotoSansSemiCondensedLight;">In that complicated relationship, they never managed to understand each other</div>`;
