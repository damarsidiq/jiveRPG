...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 288px; left: 388px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">Los crayones apilados en la caja eran un arcoíris de colores</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 288px; left: 386px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">The crayons stacked in the box were a rainbow of colors.</div>`;
