...
vt[vt.length]=`<div id="text_8" class="textshirt mergershirt" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 18px; color: rgb(81, 81, 81);">Todo el mundo 'elogia' su amabilidad.</div>`;
...
vte[vte.length]=`<div id="text_18" class="textshirt mergershirt`+transws+`" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 18px; color: rgb(81, 81, 81);">Everyone praises his kindness.</div>`;
