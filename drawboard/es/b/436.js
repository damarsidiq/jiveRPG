...
vt[vt.length]=`<div id="text_31" class="textshirt mergershirt" style="top: 138px; left: 409px; font-size: 16px; font-family: FuturaBookItalic;">Es un padre completamente entregado a sus hijos.</div>`;
vt[vt.length]=`<div id="text_32" class="textshirt mergershirt" style="top: 300px; left: 407px; font-size: 18px; font-family: AvenirBook;">El paquete fue entregado esta mañana.</div>`;
...
vte[vte.length]=`<div id="text_61" class="textshirt mergershirt`+transws+`" style="top: 138px; left: 409px; font-size: 16px; font-family: FuturaBookItalic;">He is a father completely devoted to his children.</div>`;
vte[vte.length]=`<div id="text_62" class="textshirt mergershirt`+transws+`" style="top: 300px; left: 407px; font-size: 18px; font-family: AvenirBook;">The package was delivered this morning.</div>`;
