...
vt[vt.length]=`<div id="text_8" class="textshirt mergershirt copytopaste" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 19px; color: rgb(81, 81, 81);">La fama del autor 'trasciende' las fronteras de su país.</div>`;
...
vte[vte.length]=`<div id="text_18" class="textshirt mergershirt`+transws+`" style="top: 441px; left: 396px; font-family: NotoSansSemiCondensedLight; font-size: 19px; color: rgb(81, 81, 81);">The author's fame transcends his country's borders.</div>`;
