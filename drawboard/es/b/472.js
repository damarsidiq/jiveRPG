...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 630px; font-size: 20px; font-family: NotoSansSemiCondensedLight;">Ese bribón me robó la cartera otra vez.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 628px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">No confíes en ese bribón del mercado.</div>`;
...
vte[vte.length]=`<div id="text_19" class="textshirt mergershirt`+transws+`" style="top: 102px; left: 637px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">That scoundrel stole my wallet again.</div>`;
vte[vte.length]=`<div id="text_20" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 635px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Don't trust that scoundrel at the market.</div>`;
