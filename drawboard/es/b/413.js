...
vt[vt.length]=`<div id="text_8" class="textshirt mergershirt" style="top: 441px; left: 396px; font-family: Trebuchet; font-size: 18px; color: rgb(81, 81, 81);">Mis padres dicen que no quieren que sus hijos 'envejecen' solos.</div>`;
...
vte[vte.length]=`<div id="text_18" class="textshirt mergershirt`+transws+`" style="top: 441px; left: 396px; font-family: Trebuchet; font-size: 18px; color: rgb(81, 81, 81);">My parents say they don't want their children to grow old alone.</div>`;
