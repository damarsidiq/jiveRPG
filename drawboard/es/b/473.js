...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 68px; left: 633px; font-size: 20px; font-family: NotoSansSemiCondensedLight;">Espero que él me pague lo que me debe.</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 164px; left: 631px; font-size: 18px; font-family: NotoSansSemiCondensedLight;">Dile que pague la cuenta antes de irse.</div>`;
...
vte[vte.length]=`<div id="text_19" class="textshirt mergershirt`+transws+`" style="top: 102px; left: 637px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">I hope he pays me what he owes me.</div>`;
vte[vte.length]=`<div id="text_20" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 635px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Tell him to pay the bill before leaving.</div>`;
