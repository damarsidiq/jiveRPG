...
vt[vt.length]=`<div id="text_8" class="textshirt mergershirt" style="top: 441px; left: 396px; font-family: Trebuchet; font-size: 18px; color: rgb(81, 81, 81);">La abuela tejió una 'manta' de lana para el bebé.</div>`;
...
vte[vte.length]=`<div id="text_18" class="textshirt mergershirt`+transws+`" style="top: 441px; left: 396px; font-family: Trebuchet; font-size: 18px; color: rgb(81, 81, 81);">Grandma knitted a wool blanket for the baby.</div>`;
