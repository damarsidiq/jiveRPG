...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 563px; font-size: 15px; font-family: NotoSansSemiCondensedLight;">Esos esfuerzos fueron inútiles porque el mercado ya había cambiado</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 561px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">No gastes tiempo en herramientas inútiles; busca soluciones que escalen</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 561px; font-size: 15px; font-family: NotoSansSemiCondensedLight;">Don't waste time on useless tools; look for solutions that scale</div>`;
