...
vt[vt.length]=`<div id="text_14" class="textshirt mergershirt" style="top: 102px; left: 563px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">Cuando se plantea esta duda, debemos revisar toda la estrategia anterior</div>`;
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 198px; left: 561px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">La pregunta de cómo escalar se plantea con urgencia tras el éxito inicial</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 198px; left: 557px; font-size: 13px; font-family: NotoSansSemiCondensedLight;">The question of how to scale is posed with urgency after the initial success</div>`;
