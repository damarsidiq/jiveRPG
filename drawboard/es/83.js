...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 275px; left: 709px; font-size: 17px; font-family: NotoSansSemiCondensedLight;">Cabe resaltar el esfuerzo de todo el equipo</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 276px; left: 703px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">It should be emphasized / We should highlight the effort of the whole team.</div>`;
