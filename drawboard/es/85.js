...
vt[vt.length]=`<div id="text_4" class="textshirt mergershirt" style="top: 276px; left: 711px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">Necesito revisar los números del informe</div>`;
...
vte[vte.length]=`<div id="text_4" class="textshirt mergershirt`+transws+`" style="top: 276px; left: 711px; font-size: 14px; font-family: NotoSansSemiCondensedLight;">I need to check the numbers in the report.</div>`;
