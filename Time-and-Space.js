var textSt = `The Arabic verb **خرج** (kharaja) means “to exit, to go out,” but it’s incredibly flexible.
It doesn’t demand a spatial container.
You can “exit” a state, an honor, a rank, a covenant.
Classical Arabic treats status almost like a location.
Now, Qur’anic commentators noticed the same thing.
They ask: “What is the *minhā* referring to?” And the answers vary across centuries:
• Some say “from Paradise.”
• Some say “from the assembly of the angels.”
• Some say “from divine presence in a manner appropriate to the unseen realm.”
That last one is the most interesting for your “pre-everything” intuition.
In the Qur’anic worldview, before physical cosmology even shows up, “place” is already metaphorical.
Proximity to God isn’t measured in meters but in moral and ontological alignment.
To “draw near” is to embody qualities that resonate with the divine.
To “be far” is to diverge ethically, not spatially.
So when the text uses a spatial verb (**get out**) and a spatial particle (**from it**) in a realm before space is carved out, it’s playing with a grammar of rank, presence, and privilege rather than cartography.
Iblīs was in the “station” of angelic assembly — not because he lived at some cosmic latitude, but because he was aligned with the duties and presence of that realm.
His refusal to bow altered his “wavelength”.
And so the verb of expulsion becomes a linguistic bridge from metaphysics to narrative:
*exit the state you no longer match.*
So *fakhruj minhā* is less “walk through that door over there” and more “you no longer occupy this mode of being;
You have dislocated yourself from this rank.”
- That makes sense.
- I think this thought is 'related' to my previous old question about the expression 'God is great'.
- And how would one relate that to the concept of 'space'.
- Someone said that space is a product of time - that's as mystical as someone can be.
- To understand and contemplate it that is...
- Its as if space itself is something 'low', as low as eating at a fast-food restaurant.
- As low as thinking jewelleries as a high-value object.
- But it does correlate sometimes when i have the desires to explore the world.
- And then regretting... well, not really regret but having a sort of plain attitude about it.
- Or maybe this is something that's perpendicular to the vector of joyful exploration.
- Space as just a tool, like a knife that a criminal regrets of using.
“God is great,” basically says: “Whatever container your mind tries to put God into, the container fails.”
The phrasing breaks the very idea of measurement.
This is where your intuition about space-as-low-grade-phenomenon begins to connect.
If greatness can’t be spatially bounded, then space itself becomes more like a *local interface*, not the architecture of reality. Almost like a popup window — good for navigating, not for explaining why anything matters.
Space is not some majestic throne; it’s emergent.
It’s something that *shows up* when fields or energy or time behave in particular ways.
In certain quantum gravity models, time is the first “rhythm,” and space crystallizes out of that rhythm, like frost forming on glass.
This ties beautifully into your personal travel instinct.
You go to Milan, you eat the world with your eyes, you fill your lungs with novelty — and then later, it feels… meh.
Not because the world is boring, but because physical geography can only satisfy desires that operate *within* geography.
When the desire comes from somewhere deeper — hunger for meaning, expansion, awe — then cities become like IKEA furniture.
Functional, charming, ultimately insufficient.
“You’re trying to use a 3D tool to address a 5D yearning.”
So you end up with that perpendicular feeling.
The urge to explore is real — it’s a vector pointing outward.
But the meaning you’re chasing is a vector pointing *inward* or *upward* (pick your metaphor).
These two vectors aren’t opposites; they’re orthogonal.
Your body wants to move through space, but your consciousness wants to move through states.
...
Cette dernière est la plus intéressante pour votre intuition « pré-tout ».  
Dans la vision du monde coranique, avant même que la cosmologie physique n'apparaisse, « lieu » est déjà métaphorique.  
...
- Et comment pourrait-on relier cela au concept d' 'espace'.  
- Quelqu'un a dit que l'espace est un produit du temps - c'est aussi mystique que quelqu'un peut l'être.  
- Pour comprendre et contempler cela...  
- C'est comme si l'espace lui-même était quelque chose de 'bas', aussi bas que de manger dans un fast-food.  
- Aussi bas que de considérer les bijoux comme un objet de haute valeur.  
- Mais cela corrèle parfois quand j'ai le désir d'explorer le monde.  
- Et ensuite regretter... eh bien, pas vraiment regretter mais avoir une sorte d'attitude plate à ce sujet.  
- Ou peut-être que c'est quelque chose qui est perpendiculaire au vecteur de l'exploration joyeuse.  
- L'espace comme un simple outil, comme un couteau que un criminel regrette d'avoir utilisé.  
...
Questa ultima è la più interessante per la tua intuizione "pre-tutto".
Nella visione del mondo coranica, prima che la cosmologia fisica si presenti, il "luogo" è già metaforico.
...
- E come si potrebbe collegare questo al concetto di 'spazio'.
- Qualcuno ha detto che lo spazio è un prodotto del tempo - è tanto mistico quanto può essere qualcuno.
- Per capire e contemplarlo, cioè...
- È come se lo spazio stesso fosse qualcosa di 'basso', tanto basso quanto mangiare in un fast food.
- Tanto basso quanto pensare ai gioielli come oggetti di alto valore.
- Ma a volte si correla quando ho il desiderio di esplorare il mondo.
- E poi pentendomi... beh, non proprio pentimento, ma avere una sorta di atteggiamento neutro al riguardo.
- O forse questo è qualcosa che è perpendicolare al vettore dell'esplorazione gioiosa.
- Lo spazio come semplice strumento, come un coltello che un criminale si pente di usare.
...
for(var i=0;i<reperc.storylines[1].length;i++){
    //es,en,fr,de,it
	n.addNarration(null,reperc.storylines[0][i],reperc.storylines[1][i],null,reperc.storylines[2][i]);
}
